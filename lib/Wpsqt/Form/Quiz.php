...
class Wpsqt_Form_Quiz extends Wpsqt_Form {
	...
	public function __construct( array $options = array() ){
		...
		$this->addOption("wpsqt_name", "Name", "text", $options['name'], "What you would like the quiz to be called." )
			 ...
			 ->addOption("wpsqt_notification_email", "Notification Email", "text", $options['notification_email'], "The email address which is to be notified when the quiz is completed. Emails can be separated by a comma. <strong>Will override plugin wide option.</strong>", array(), false )
