			...
			<tbody>
				...
				<tr>
					...
					<td class="column-title">
						<strong>
							<a class="row-title" href="<?php echo WPSQT_URL_MAIN; ?>&section=results&subsection=survey&id=<?php echo urlencode($_GET['id']); ?>&resultid=<?php echo $result['id']; ?>"><?php echo esc_html($result['person_name']);  if (isset($person['email'])){ ?> - <?php echo $person['email']; } ?></a>
						</strong>
